...
public class RoutingFilter implements Filter {
    private static ShowErrorPage errorTemplate;
    private static Pattern blockedPaths;

    public static void init(ShowErrorPage errorTemplate, String blockedPaths) {
        ...
        RoutingFilter.errorTemplate = errorTemplate;
    }
    ...
    public Future<Result> apply(Function1<RequestHeader, Future<Result>> next, RequestHeader rh) {
        if(hasTrailingSlash(rh)) {
            ...
            return errorTemplate.onHandlerNotFound(rh);
        } else {
